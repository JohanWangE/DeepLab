...
class Residual_block(nn.Module):
    ...
    def forward(self,x):
        ...
        for i in range(self.blocks):
            out = out + self.basic_block[i](out)
        if self.subsample:
...
class ResNet(nn.Module):
    def __init__(self,block_num,out_classes=10):
        ...
        self.block_list.append(Residual_block(16, 32, 3, block_num))
        self.block_list.append(Residual_block(32, 64, 3, block_num))
        self.block_list.append(Residual_block(64, 64, 3, block_num,subsample=False))
